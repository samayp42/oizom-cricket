...
const KnockoutMatchSetup = () => {
    const { teams, createKnockoutMatch } = useTournament();
    const navigate = useNavigate();
    const [searchParams] = useSearchParams();
    const gameType = (searchParams.get('game') as GameType) || 'badminton';

    const [stage, setStage] = useState<KnockoutMatchStage>('round_1');
    const [matchType, setMatchType] = useState<KnockoutMatchType>('singles');
    ...
    const handleSubmit = () => {
        if (!isReady) return;
        createKnockoutMatch(gameType, teamAId, teamBId, stage, matchType, teamAPlayers, teamBPlayers);
        navigate('/admin');
    };
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl border border-slate-100">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <select
                                    value={stage}
                                    onChange={(e) => setStage(e.target.value as KnockoutMatchStage)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="bg-white rounded-3xl p-6 shadow-xl border border-slate-100">
                            ...
                            >
                                ...
                                <option value="BYE">BYE (Skip)</option>
...
export default KnockoutMatchSetup;
